...
try:
    profile_reg_pg = playerprofilev2.PlayerProfileV2(player_id=player_id, per_mode36="PerGame", season_type_all_star="Regular Season")
    ...
    if not df_reg_pg_seasons.empty:
        ...
        print(df_reg_pg_seasons[['SEASON_ID', 'TEAM_ABBREVIATION', 'GP', 'MIN', 'PTS', 'REB', 'AST', 'STL', 'BLK', 'FG_PCT', 'FG3_PCT', 'FT_PCT']].head(2))
...
try:
    profile_post_pg = playerprofilev2.PlayerProfileV2(player_id=player_id, per_mode36="PerGame", season_type_all_star="Playoffs")
    ...
    if not df_post_pg_seasons.empty:
        ...
        print(df_post_pg_seasons[['SEASON_ID', 'TEAM_ABBREVIATION', 'GP', 'MIN', 'PTS', 'REB', 'AST', 'STL', 'BLK', 'FG_PCT', 'FG3_PCT', 'FT_PCT']].head(2))
...
try:
    profile_reg_adv = playerprofilev2.PlayerProfileV2(player_id=player_id, per_mode36="Advanced", season_type_all_star="Regular Season")
    ...
    if not df_reg_adv_seasons.empty:
        ...
        adv_cols_to_show = ['SEASON_ID', 'TEAM_ABBREVIATION', 'GP', 'MIN', 'OFF_RATING', 'DEF_RATING', 'NET_RATING', 'AST_PCT', 'AST_TOV', 'AST_RATIO', 'OREB_PCT', 'DREB_PCT', 'REB_PCT', 'TM_TOV_PCT', 'EFG_PCT', 'TS_PCT', 'USG_PCT', 'PACE', 'PIE', 'WS']
        # Filter to columns that actually exist in the dataframe
        existing_adv_cols = [col for col in adv_cols_to_show if col in df_reg_adv_seasons.columns]
...
try:
    profile_post_adv = playerprofilev2.PlayerProfileV2(player_id=player_id, per_mode36="Advanced", season_type_all_star="Playoffs")
    ...
    if not df_post_adv_seasons.empty:
        ...
        adv_cols_to_show = ['SEASON_ID', 'TEAM_ABBREVIATION', 'GP', 'MIN', 'OFF_RATING', 'DEF_RATING', 'NET_RATING', 'AST_PCT', 'AST_TOV', 'AST_RATIO', 'OREB_PCT', 'DREB_PCT', 'REB_PCT', 'TM_TOV_PCT', 'EFG_PCT', 'TS_PCT', 'USG_PCT', 'PACE', 'PIE', 'WS']
        existing_adv_cols = [col for col in adv_cols_to_show if col in df_post_adv_seasons.columns]
...
try:
    ...
    if not career_reg_pg.empty:
        print(career_reg_pg[['PLAYER_ID', 'GP', 'MIN', 'PTS', 'REB', 'AST', 'STL', 'BLK', 'FG_PCT', 'FG3_PCT', 'FT_PCT']].head())
...
try:
    ...
    if not career_post_pg.empty:
        print(career_post_pg[['PLAYER_ID', 'GP', 'MIN', 'PTS', 'REB', 'AST', 'STL', 'BLK', 'FG_PCT', 'FG3_PCT', 'FT_PCT']].head())
...
try:
    ...
    adv_cols_to_show = ['PLAYER_ID', 'GP', 'MIN', 'OFF_RATING', 'DEF_RATING', 'NET_RATING', 'AST_PCT', 'AST_TOV', 'AST_RATIO', 'OREB_PCT', 'DREB_PCT', 'REB_PCT', 'TM_TOV_PCT', 'EFG_PCT', 'TS_PCT', 'USG_PCT', 'PACE', 'PIE', 'WS']
    existing_adv_cols = [col for col in adv_cols_to_show if col in career_reg_adv.columns]
...
try:
    ...
    if not career_post_adv.empty:
        adv_cols_to_show = ['PLAYER_ID', 'GP', 'MIN', 'OFF_RATING', 'DEF_RATING', 'NET_RATING', 'AST_PCT', 'AST_TOV', 'AST_RATIO', 'OREB_PCT', 'DREB_PCT', 'REB_PCT', 'TM_TOV_PCT', 'EFG_PCT', 'TS_PCT', 'USG_PCT', 'PACE', 'PIE', 'WS']
        existing_adv_cols = [col for col in adv_cols_to_show if col in career_post_adv.columns]
